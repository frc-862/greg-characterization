...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		CANSparkMax leftFollowerID3 = setupCANSparkMax(3, Sides.FOLLOWER, true);
	...
	public void autonomousPeriodic() {
		...
		double robotVoltage = RobotController.getBatteryVoltage();
		double motorVolts = robotVoltage * Math.abs(priorAutospeed);
